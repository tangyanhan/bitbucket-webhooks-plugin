...
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_BRANCH_CREATED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_BRANCH_DELETED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_BUILD_STATUS;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_ENABLED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_IGNORED_BRANCHES;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_IGNORED_COMMITERS;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_COMMENTED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_CREATED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_DECLINED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_MERGED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_REOPENED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_RESCOPED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_PR_UPDATED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_REPO_ID;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_REPO_PUSH;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_TAG_CREATED;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_TITLE;
import static nl.eernie.bitbucket.persistence.WebHookConfiguration.COLUMN_URL;
